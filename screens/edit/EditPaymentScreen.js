...
const EditPaymentScreen = ({ navigation, route }) => {
  ...
  const [roomNumber, setRoomNumber] = useState(tenant.room);
  const [bedNumber, setBedNumber] = useState('1'); // Sample bed number
  const [dateOfPayment, setDateOfPayment] = useState(new Date('2024-05-19')); // Sample date
  const [amount, setAmount] = useState('100'); // Sample amount
  const [showDatePicker, setShowDatePicker] = useState(false);
  const [image, setImage] = useState(null);
  const [modalVisible, setModalVisible] = useState(false);

  useEffect(() => {
    // If you need to load initial data or images
  }, []);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.formContainer}>
        <Text style={styles.label}>Edit Payment Details</Text>
        ...
        <View style={styles.row}>
          <View style={styles.pickerContainer}>
            ...
            >
              ...
              <Picker.Item label="Room 1" value="Room 1" />
              <Picker.Item label="Room 2" value="Room 2" />
              <Picker.Item label="Room 3" value="Room 3" />
              <Picker.Item label="Room 4" value="Room 4" />
            </Picker>
          </View>
